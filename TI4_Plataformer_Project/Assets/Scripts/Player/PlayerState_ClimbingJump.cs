...
public class PlayerState_ClimbingJump : PlayerState
{
    ...
    public float currentHeight = 1.1f;
    ...
    {
        player.PlayerAnimations.JumpAnimation(4);
        //CalculateParameters();
    ...
    public void IncreaseDefaultHeight(float amount)
    {
        currentHeight = defaultHeight * amount;
        CalculateParameters();
    }

    private void CalculateParameters()
    {
        initialJumpVelocity = (2f * currentHeight) / defaultTimeToApex;
        gravityAcceleration = (2f * currentHeight) / -Mathf.Pow(defaultTimeToApex, 2);
    }
